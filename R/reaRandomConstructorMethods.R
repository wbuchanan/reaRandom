...
#' @rdname setIntegers
#' @aliases setIntegers,numeric,numeric,numeric,numeric,logical,numeric-method
#' @export setIntegers
#'
...
#' @family REARandom Constructor Methods
#' @rdname setDecimals
#' @aliases setDecimals,numeric,numeric,numeric,logical-method
#' @export setDecimals
#'
...
#' @family REARandom Constructor Methods
#' @rdname setNormal
#' @aliases setNormal,numeric,numeric,numeric,numeric,numeric-method
#' @export setNormal
#'
